...
PROJECT_DIR="${PROJECT_DIR:-/Users/marcio_oliveira/Development/teamwill/mobilize/hyperfront}"
...
SONAR_PROJECT_KEY="${SONAR_PROJECT_KEY:-hyperfront}"
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    --help|-h)
      ...
      echo "  --project-key <key>       Project key (default: hyperfront)"
      ...
      echo "  $0 --token YOUR_TOKEN --project-key hyperfront-prod"
      exit 0
      ;;
    *)
...
echo "Running SonarQube analysis for hyperfront..."
