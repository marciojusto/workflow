...
4. Inform user about outstanding changes for manual commit.

### Resume

1. Read `.specs/STATE.md` — both sections.
2. Re-confirm active decisions from `## Decisions` — nothing superseded since last session?
3. Read `## Handoff` — identify feature, phase/task, next step, blockers, changes pending user commit, branch.
